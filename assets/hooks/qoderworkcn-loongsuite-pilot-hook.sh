...
# ============================================================================
# Qoder Work CN Hook Script — delegates to qoderwork-hook-processor.mjs
# ============================================================================
# Usage:
#   qoderworkcn-loongsuite-pilot-hook.sh
#
#   Writes to logs/qoder-work-cn/history/qoder-work-cn-*.jsonl.
#
# Installation:
#   HookManager copies this script + qoderwork-hook-processor.mjs to
